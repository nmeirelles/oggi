function createDataset(fields, constraints, sortFields) {
	...
	try{
		...
		var clientService = fluigAPI.getAuthorizeClientService();	
			  ...
			  data.params.formFields["nomeColaborador"] = ""+nomeAprovado
			  data.params.formFields["emailSolicitante"] = ""+emailAprovado
			  data.params.formFields["contatoSolicitante"] = ""+contatoAprovado
